    ...
    <div class="faq-section mt-4">
        <ol>
            ...
            <li>
                ...
                <p>To create an account, click on the "Sign Up" button on the homepage. Fill in the required details and submit the form. You will receive a confirmation email to verify your account.</p>
            </li>
            <li>
            ...
            <li>
                ...
                <p>Currently, our platform is only for buyers. We do not support user listings for selling items.</p>
            </li>
        </ol>
    </div>
</div>
