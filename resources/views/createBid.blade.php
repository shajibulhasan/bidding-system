                    ...
                    <div class="card-body card">
                        ...
                        @csrf
                            <div class="col-12">
                                ...
                                <input type="text" placeholder="Product Name" class="form-control" value="{{old('name')}}" id="name" name="name">
                                @if($errors->has('name'))
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" placeholder="Product Description" class="form-control" value="{{old('description')}}" id="description" name="description">
                            ...
                            <div class="col-12">
                                ...
                                <input type="number" placeholder="Biding Price" class="form-control" value="{{old('starting_price')}}" id="price" name="starting_price">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" placeholder="Starting Bid" class="form-control" value="{{old('starting_date')}}" id="start" name="starting_date">
                            ...
                            <div class="col-12">
                                ...
                                <input type="date" placeholder="Ending Bid" class="form-control" value="{{old('ending_date')}}" id="end" name="ending_date">
